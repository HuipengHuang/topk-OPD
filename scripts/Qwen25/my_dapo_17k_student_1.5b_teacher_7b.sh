...
# ========== 训练参数 ==========
STUDENT_MODEL=/data/common/LLMs/Qwen/Qwen2.5-Math-1.5B
TEACHER_MODEL=/data/common/LLMs/DeepSeek-R1-Distill-Qwen-7B
...
PROJECT_NAME=dapo17k_qwen25_15b_base_from_r1_7b
