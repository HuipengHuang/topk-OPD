...
TEACHER_MODEL=/data/common/LLMs/Qwen3-8B

TRAIN_DATA=/data/home/huanghp/data/OpenR1-Math-46k/OpenR1-Math-46k.parquet
...
PROJECT_NAME=openr1_qwen3_17b_base_from_qwen3_8b
EXPERIMENT_NAME=correct_loss_${DISTILL_LOSS_MODE}_topk_${DISTILL_TOPK}_lr_${LR}
