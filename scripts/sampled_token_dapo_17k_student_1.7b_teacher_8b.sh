...
TRAIN_DATA=/data/home/huanghp/data/DAPO-Math-17k/dapo-math-17k.parquet
...
LR=1e-6
N_ROLLOUTS=4
DISTILL_LOSS_MODE=k1

PROJECT_NAME=dapo17k_qwen3_17b_base_from_qwen3_8b
EXPERIMENT_NAME=loss_${DISTILL_LOSS_MODE}_lr_${LR}
