...
def compute_topk_loss(
    ...
    match config.strategy:
        ...
        case "fsdp" | "veomni":
            ...
            if loss_mode == "normalized_forward_kl_topk":
                distillation_loss_fn = fsdp_losses.compute_normalized_forward_kl_topk
            elif loss_mode == "forward_kl_topk":
                distillation_loss_fn = fsdp_losses.compute_forward_kl_topk
            elif loss_mode == "my_forward_kl_topk":
                distillation_loss_fn = fsdp_losses.compute_my_forward_kl_topk
            elif loss_mode == "reverse_kl_topk":
                distillation_loss_fn = fsdp_losses.compute_reverse_kl_topk
            elif loss_mode == "my_reverse_kl_topk":
                distillation_loss_fn = fsdp_losses.compute_my_reverse_kl_topk
            elif loss_mode == "normalized_reverse_kl_topk":
                distillation_loss_fn = fsdp_losses.compute_normalized_reverse_kl_topk
            else:
...
@register_distillation_loss(DistillationLossSettings(names=["forward_kl_topk", "normalized_forward_kl_topk", "my_forward_kl_topk"], use_topk=True))  # type: ignore[arg-type]
...
@register_distillation_loss(DistillationLossSettings(names=["reverse_kl_topk", "normalized_reverse_kl_topk", "my_reverse_kl_topk"], use_topk=True))  # type: ignore[arg-type]
...
# @register_distillation_loss(DistillationLossSettings(names=["normalized_forward_kl_topk"], use_topk=True))  # type: ignore[arg-type]
...
#
#
# @register_distillation_loss(DistillationLossSettings(names=["my_forward_kl_topk"], use_topk=True))  # type: ignore[arg-type]
# def compute_my_kl_topk(
#     config: ActorConfig,
#     distillation_config: DistillationConfig,
#     model_output: dict,
#     data: TensorDict,
